      ...
      <main>
        ...
        <section className="section compact-section home-order-section">
          <div className="container narrow-container">
            <div className="section-head center">
              ...
              <p className="muted">Оберіть кількість сенсорів, додайте транспондер за потреби та оформіть оплату через Hutko.</p>
            </div>
            <CheckoutForm />
          </div>
        </section>
        ...
        <section className="section compact-section">
          <div className="container cta-panel">
            <div>
              <span className="kicker">Hutko + Telegram + AI</span>
            ...
            <a className="btn btn-primary" href={localePath(locale, "pricing")}>Hutko billing</a>
          </div>
        </section>
      </main>
    </>
