...
type InstallationContentProps = {
  locale: Locale;
  miniApp?: boolean;
};

export function InstallationContent({ locale, miniApp = false }: InstallationContentProps) {
  const t = content[locale];

  return (
      <main className={miniApp ? "telegram-install-main" : undefined}>
